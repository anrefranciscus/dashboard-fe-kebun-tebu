const Navbar = () => {
  return (
    <nav className="flex overflow-hidden flex-wrap gap-10 justify-center px-8 py-3.5 w-full text-sm font-medium tracking-normal leading-none text-center text-lime-600 whitespace-nowrap bg-white border-b border-solid border-b-neutral-200 max-md:px-5 max-md:max-w-full">
